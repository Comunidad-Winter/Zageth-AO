...
UserList(UserIndex).Stats.AntiTrucheo = CInt(UserFile.GetValue("MUERTES", "AntiTrucheo"))
...
UserList(UserIndex).flags.UGLOBAL = CByte(UserFile.GetValue("FLAGS", "Global"))
...
ModOro = val(GetVar(DatPath & "Opciones.ini", "OPCION", "Oro"))
ModExp = val(GetVar(DatPath & "Opciones.ini", "OPCION", "Exp"))
...
EstadoGlobal = val(GetVar(IniPath & "Server.ini", "INIT", "Global"))
...
ExpMod = val(GetVar(IniPath & "\Opciones.ini", "CONFIG", "ExpMod"))
GldMod = val(GetVar(IniPath & "\Opciones.ini", "CONFIG", "GldMod"))
ExpEVENTO = val(GetVar(IniPath & "\Opciones.ini", "EVENTO", "ExpEVENTO"))
GldEVENTO = val(GetVar(IniPath & "\Opciones.ini", "EVENTO", "GldEVENTO"))
...
Call WriteVar(UserFile, "FLAGS", "Global", CStr(UserList(UserIndex).flags.UGLOBAL))
...
Call WriteVar(UserFile, "MUERTES", "AntiTrucheo", CStr(UserList(UserIndex).Stats.AntiTrucheo))
...
Npclist(NpcIndex).GiveEXP = val(GetVar(npcfile, "NPC" & NpcNumber, "GiveEXP")) * ModExp

Npclist(NpcIndex).GiveGLD = val(GetVar(npcfile, "NPC" & NpcNumber, "GiveGLD")) * ModOro
