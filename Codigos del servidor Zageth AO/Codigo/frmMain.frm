...
Call SendData(SendTarget.ToAll, 0, 0, "||Zageth AO> " & BroadMsg.Text & FONTTYPE_SERVER)
End Sub
...
Call SendData(SendTarget.ToAll, 0, 0, "||Zageth AO> Atencion, 3 minutos para limpieza del mundo. Tomar items del piso." & FONTTYPE_SERVER)
End If
...
Private Sub Timer2_Timer()
        If Hour(Now) = 11 Then
            ...
            Call SendData(SendTarget.ToAll, 0, 0, "||Finalizo el evento de Oro x 2 y Experiencia x 2" & FONTTYPE_SERVER)
...
Private Sub Timer3_Timer()
        If Hour(Now) = 10 Then
            ...
            Call SendData(SendTarget.ToAll, 0, 0, "||Comenzo el evento de Oro x 2 y Experiencia x 2, el cual finalizará dentro de 1 hora." & FONTTYPE_SERVER)
