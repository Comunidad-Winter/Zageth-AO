...
Call SendData(SendTarget.ToAll, 0, 0, "||Zageth AO> Iniciando WorldSave" & FONTTYPE_SERVER)
...
Call SendData(SendTarget.ToAll, 0, 0, "||Zageth AO> WorldSave ha concluído" & FONTTYPE_SERVER)
