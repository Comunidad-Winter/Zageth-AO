...
On Error Resume Next
   ...
   Exit Sub
    ...
    Call SendData(SendTarget.ToPCArea, UserIndex, UserList(UserIndex).Pos.Map, "||" & vbBlue & "°" & s & "°" & ind)
    End If
...
Call SendData(SendTarget.ToIndex, UserIndex, 0, "||No podes atacar desnudo" & FONTTYPE_WARNING)
Exit Sub
End If
