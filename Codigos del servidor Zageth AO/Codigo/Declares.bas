...
Public ModOro As Byte
Public ModExp As Byte

Public BodyDemonio As Byte
    Public BodyAngel As Byte
    Public MapaGuerra As Byte
    Public MGAX As Byte
    Public MGAY As Byte
    Public MGAX2 As Byte
    Public MGAY2 As Byte
    Public MGDX As Byte
    Public MGDY As Byte
    Public MGDX2 As Byte
    Public MGDY2 As Byte
...
Public Const TimerCleanWorld As Byte = 15

Public ExpMuChAIaO As Byte
Public ExpMod As Long
Public GldMod As Long
Public ExpEVENTO As Long
Public GldEVENTO As Long
...
Public Const MaxOro As Long = 99000000
...
Public Const FONTTYPE_APU As String = "~255~128~0~1~0"
...
Public Const FONTTYPE_CHEAT As String = "~0~255~0~1~0"
...
Public Function Aleatorio(ByVal Minimo As Long, ByVal Maximo As Long) As Long
     Randomize
