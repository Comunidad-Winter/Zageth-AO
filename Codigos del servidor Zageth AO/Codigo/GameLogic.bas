              ...
              Dim LevelZagethAO As Integer
               ...
               LevelZagethAO = 5
                ...
                End If
                 ...
                 If UserList(UserIndex).Stats.ELV >= UserList(TempCharIndex).Stats.ELV + LevelZagethAO Or UserList(UserIndex).Stats.ELV >= UserList(TempCharIndex).Stats.ELV Or _
                    UserList(UserIndex).Stats.ELV + LevelZagethAO >= UserList(TempCharIndex).Stats.ELV Then
...
End If
    ...
    If FoundChar = 2 Then '¿Encontro un NPC?
            Dim estatus As String
                  ...
                  If Npclist(TempCharIndex).Hostile = 1 Or Npclist(TempCharIndex).Attackable = 1 Then
                Call SendData(SendTarget.ToIndex, UserIndex, 0, "TL" & Npclist(TempCharIndex).name & "," & Npclist(TempCharIndex).GiveGLD & "," & Npclist(TempCharIndex).Stats.MinHP & " / " & Npclist(TempCharIndex).Stats.MaxHP & "," & Npclist(TempCharIndex).GiveEXP & "," & Npclist(TempCharIndex).Stats.def & "," & Npclist(TempCharIndex).Stats.MinHIT & " / " & Npclist(TempCharIndex).Stats.MaxHIT & "," & Npclist(TempCharIndex).PoderEvasion & "," & Npclist(TempCharIndex).PoderAtaque)
            End If
