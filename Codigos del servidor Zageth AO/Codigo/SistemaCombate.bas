...
Call SendData(SendTarget.ToIndex, UserIndex, 0, "||Es un Golpe Critico! (+" & Round(daño * 0.1, 0) & ")" & FONTTYPE_INFON)
...
Select Case Lugar
        ...
        Call SendData(SendTarget.ToIndex, VictimaIndex, 0, "||Es un Golpe Critico! (+" & Round(daño * 0.1, 0) & ")" & FONTTYPE_INFON)
        Call SendData(SendTarget.ToIndex, AtacanteIndex, 0, "||Es un Golpe Critico! (+" & Round(daño * 0.1, 0) & ")" & FONTTYPE_INFON)
