...
SendData "IT" & Inventario.SelectedItem & "," & frmCantidad.text1.Text
...
If Inventario.SelectedItem <> FLAGORO Then
    SendData "IT" & Inventario.SelectedItem & "," & Inventario.Amount(Inventario.SelectedItem)
Else
    SendData "IT" & Inventario.SelectedItem & "," & UserGLD
End If
